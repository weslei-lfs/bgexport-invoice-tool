...
async function launchBrowser() {
  ...
  // Both @sparticuz/chromium and this version of puppeteer-core ship as
  // ESM-only packages, so they must be loaded via dynamic import() even from
  // this CommonJS file - a plain require() throws ERR_REQUIRE_ESM.
